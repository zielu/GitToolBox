...
public class PerRepoInfoCacheImpl implements PerRepoInfoCache, GitRepositoryChangeListener, Disposable,
    ProjectAware, VcsListener {
  ...
  private PerRepoInfoCacheImpl(@NotNull Application application, @NotNull Project project) {
  ...
  public static PerRepoInfoCacheImpl create(@NotNull Project project) {
    return new PerRepoInfoCacheImpl(ApplicationManager.getApplication(), project);
  }
