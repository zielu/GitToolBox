...
public class GtPrjForm implements GtFormUi {
    ...
    private void createUIComponents() {
        ...
        addPatternCompletionAction = new AbstractActionExt() {
            {
    ...
    public void init() {
        ...
        autoFetchEnabledCheckBox.addItemListener(e -> autoFetchIntervalSpinner.setEnabled(autoFetchEnabledCheckBox.isSelected()));
        ...
        completionItemList.setCellRenderer(new ColoredListCellRenderer<CommitCompletionConfig>() {
            @Override
            protected void customizeCellRenderer(@NotNull JList<? extends CommitCompletionConfig> list, CommitCompletionConfig value, int index,
    ...
    private void updateCompletionItemActions() {
        addSimpleCompletionAction.setEnabled(!completionItemModel.contains(CommitCompletionConfig.create(CommitCompletionType.SIMPLE)));
    }
