...
public class StatusActionGroupPopup extends PopupFactoryImpl.ActionGroupPopup {
    ...
    public StatusActionGroupPopup(String title, @NotNull RootActions actionGroup, @NotNull Project project, Condition<AnAction> preselectActionCondition) {
