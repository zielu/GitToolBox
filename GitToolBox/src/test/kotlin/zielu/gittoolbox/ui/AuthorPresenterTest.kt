...
internal class AuthorPresenterTest {
  ...
  @CsvSource(
    ...
    "HIDDEN,Jon Snow,jon.snow@the.wall,''"
  )
  fun `should return expected value if space inside`(
    type: AuthorNameType,
    author: String,
    email: String,
    expected: String
  ...
  @CsvSource(
    ...
    "HIDDEN,JonSnow,jon.snow@the.wall,''"
  )
  fun `should return expected value if no space inside`(
    type: AuthorNameType,
    author: String,
    email: String?,
    expected: String?
